...
There's a `SOXS Google Group <https://groups.google.com/forum/#!forum/soxs-sims>`_ to get help and
...
the best place to note it is on the `GitHub issues page <http://github.com/XRStools/soxs/issues>`_
