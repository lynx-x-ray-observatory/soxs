...
# -*- coding: utf-8 -*-
#
# soxs documentation build configuration file, created by
...
intersphinx_mapping = {
    ...
    "pyxsim": ("https://hea-www.cfa.harvard.edu/~jzuhone/pyxsim/", None),
