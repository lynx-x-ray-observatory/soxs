...
def write_event_file(events, parameters, filename, overwrite=False):
    ...
    tbhdu.header["TLMIN6"] = 1.0-parameters["det_center"][0]
    tbhdu.header["TLMAX6"] = parameters["num_pixels"]-parameters["det_center"][0]
    tbhdu.header["TLMIN7"] = 1.0-parameters["det_center"][1]
    tbhdu.header["TLMAX7"] = parameters["num_pixels"]-parameters["det_center"][1]
